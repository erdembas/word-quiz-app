      ...
      <div className="max-w-xl w-full bg-white rounded-lg shadow-md">
        ...
        <div className="p-6">
          <div className="flex items-center justify-center mb-6">
            <h3 className="text-xl font-semibold text-gray-700  text-center">{question.word}</h3>
            <button onClick={handleSpeak} className="ml-2 text-gray-500 hover:text-gray-800 transition-colors" aria-label={`Hear pronunciation of ${question.word}`}>
              🔊
            </button>
          </div>
      ...
      {showResultsModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          ...
          <div className="bg-white rounded-lg shadow-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto p-6">
            ...
            {/* Back Button */}
            <button onClick={() => setShowResultsModal(false)} className="mt-4 py-2 px-4 bg-gray-800 text-white rounded-lg shadow hover:bg-gray-900 transition w-full">
              Back to Quiz
            </button>
          </div>
        </div>
